...
export default function Drivers() {
    ...
    const tableDisplay = ["Main Image", "Restuarnt Name", "Location", "Category", "time"];
    ...
    const currentRows = filteredRestaurants.slice(indexOfFirstRow, indexOfLastRow);
                        ...
                        {currentRows.map((restaurant, index) => (
                            <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td className='py-4 px-6'>
                                    <img src={restaurant.main_image} width={"30"} height={""} alt="" />
                                </td>
                                <td className="py-4 px-6">
                                    <Link to={`/restaurants/${restaurant.rest_id}`} className="font-medium text-gray-900 dark:text-white hover:underline">
